...
class PRSLogger(object):
    def __init__(self, model, device, coefficient: float = 100):
    ...
    def compute_attentions(self, ret):
        ...
        return_value = ret[:, 0].detach().cpu()  # This is the attention output
    ...
    def finalize(self, representation):
        ...
        return (
            ...
            * projected_attentions
            ...
            self.coefficient * projected_mlps / norm[:, np.newaxis, np.newaxis],
        )
